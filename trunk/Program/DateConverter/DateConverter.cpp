...
int main(int argc, char *argv[])
{
   // no parameter = print today && (1111)
   // with parameter = conversion from (1111) to 20061023 or vise versa
   ...
   if(argc == 1)
   {
      cout << "Usage: exe 2532" << endl;
      cout << "       exe 20070501" << endl;
      cout << "Note the date format is assumed to be YYYYMMDD" << endl;
   }
   else
   {
...
string PMDateString(time_t date)
{
   ...
   time_t day1111 = Get1111();
   double diffseconds = difftime(date, day1111) + 102;
